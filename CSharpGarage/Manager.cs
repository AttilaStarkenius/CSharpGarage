...
internal class Manager
{
    ...
    public void MainMenu(IHandler currGarage)
    {
        ...
        while (true)
        {
            ...
            ui.Output("Skriv ett nummer för att navigera genom menyn \n(1, 2, 3 ,4, 5, 6, 0) of your choice"
                ...
                + "\n8. Sök efter ett namn av fordon"
            ...
            switch (input)
            {
                ...
                case ConsoleKey.D7:
                    ...
                    break;
                case ConsoleKey.D8:
                    ui.Output("Skriv in namnet av fordon du vill hitta.");
                    string name = ui.GetInput();
                    ui.PrintVehicle(currGarage.GetFromName(name));
                    break;                    
                case ConsoleKey.D0:
                    Environment.Exit(0);
                    break;
    ...
    private void FilterVehicles(IHandler currGarage, IUI ui)
    {
        ...
        while (loop)
        {
            ui.Output("Välj en egenskap att filtrera efter (1)Färg (2)Hjul 3(Namn) Eller (0) för att avsluta");
            ...
            switch (input)
            {
                ...
                case ConsoleKey.D3:
                    ui.Output("Namnet av fordon:");
                    var typeN = ui.GetInput();
                    currGarage.Filter("name", typeN, "", 0);
                    options = options + " med namn " + typeN;
